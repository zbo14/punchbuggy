 ...
 * @return {Buffer}
 */
const encode = (type, body = Buffer.alloc(0)) => {
  const head = Buffer.alloc(3)
  head.writeUint16BE(1 + body.byteLength)
  head[2] = MESSAGE_CODES[type]
...
const send = (sock, type, body) => sock.write(encode(type, body))
